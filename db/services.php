...
$functions = array(
    ...
    'mod_mediamanager_view_resource' => array(
        'classname'     => 'mod_mediamanager_external',
        'methodname'    => 'view_resource',
        'description'   => 'Simulate the view.php web interface resource: trigger events, completion, etc...',
        'type'          => 'write',
        'capabilities'  => 'mod/mediamanager:view',
        'services'      => array(MOODLE_OFFICIAL_MOBILE_SERVICE)
    ),
    'mod_mediamanager_get_resources_by_courses' => array(
        'classname'     => 'mod_mediamanager_external',
