...
/**
 * Unit tests for mod_mediamanager lib
 *
...
class lib_test extends \advanced_testcase {
     ...
     * @return void
     */
    public function test_mediamanager_view() {
        global $CFG;
    ...
    /**
     * Tests the mediamanager_get_coursemodule_info function.
     *
    ...
    public function test_get_coursemodule_info() {
        ...
        $resource1 = $generator->create_module('mediamanager', array('course' => $course->id,
        ...
        $resource2 = $generator->create_module('mediamanager', array('course' => $course->id,
        ...
        $fs->create_file_from_string($filerecord, 'Test');
        $resource3 = $generator->create_module('mediamanager', array('course' => $course->id,
                'name' => 'R3', 'files' => $draftid));

        // Try get_coursemodule_info for first one.
        $info = mediamanager_get_coursemodule_info(
    ...
    public function test_resource_core_calendar_provide_event_action() {
        ...
        $actionevent = mod_mediamanager_core_calendar_provide_event_action($event, $factory);
    ...
    /**
     * Test mod_mediamanager_core_calendar_provide_event_action with user override
     */
    public function test_resource_core_calendar_provide_event_action_user_override() {
        ...
        // Decorate action event.
        $actionevent = mod_mediamanager_core_calendar_provide_event_action($event, $factory, $USER->id);

        // Decorate action with a userid override.
        $actionevent2 = mod_mediamanager_core_calendar_provide_event_action($event, $factory, $user->id);
