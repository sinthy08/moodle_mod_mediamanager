...
namespace mod_mediamanager\search;
...
class search_test extends \advanced_testcase {
    ...
    public function setUp(): void {
        ...
        $this->resourceareaid = \core_search\manager::generate_areaid('mod_mediamanager', 'activity');
    ...
    public function test_attach_files() {
        ...
        $resource = $this->getDataGenerator()->create_module('mediamanager', $record);

        $searcharea = \core_search\manager::get_search_area($this->resourceareaid);
        $this->assertInstanceOf('\mod_mediamanager\search\activity', $searcharea);
