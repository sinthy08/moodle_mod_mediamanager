...
/**
 * mediamanager module data generator class.
 *
 * @package    mod_mediamanager
 * @copyright 2013 The Open University
 * @license http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_mediamanager_generator extends testing_module_generator {

    /**
     * Creates new mediamanager module instance. By default it contains a short
     * text file.
     *
    ...
    public function create_instance($record = null, array $options = null) {
        ...
        if (!isset($record->files)) {
            ...
            $filename = $record->defaultfilename ?? 'mediamanager' . ($this->instancecount + 1) . '.txt';
