...
/**
 * Strings for component 'mediamanager', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['modulename'] = 'Media Manager';
...
$string['modulename_link'] = 'mod/mediamanager/view';
...
$string['pluginname'] = 'Media Manager';
...
$string['awss3region'] = 'AWS S3 Region';
$string['awss3regionexplain'] = 'AWS S3 Region Name';
$string['awss3key'] = 'AWS S3 Key';
$string['awss3keyexplain'] = 'AWS S3 Key of S3 Bucket';
$string['awss3secret'] = 'AWS S3 Secret Key';
$string['awss3secretexplain'] = 'AWS S3 Secret Key of S3 Bucket';
$string['awss3bucketname'] = 'AWS S3 Bucket Name';
$string['awss3bucketnameexplain'] = 'AWS S3 Bucket Name where the file will be saved';
$string['uploaded_file'] = 'Uploaded file link';
