...
$strresource     = get_string('modulename', 'mediamanager');
$strresources    = get_string('modulenameplural', 'mediamanager');
$strsectionname  = get_string('sectionname', 'format_'.$course->format);
$strname         = get_string('name');
$strintro        = get_string('moduleintro');
$strlastmodified = get_string('lastmodified');

$PAGE->set_url('/mod/mediamanager/index.php', array('id' => $course->id));
...
if (!$resources = get_all_instances_in_course('mediamanager', $course)) {
...
foreach ($resources as $resource) {
    ...
    $table->data[] = array (
        ...
        format_module_intro('mediamanager', $resource, $cm->id));
}
